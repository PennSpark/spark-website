...
export default function InterestForm() {
  return (
    <div id="interest-form" className="join-app-container">
      ...
      >
        Our General Information Meeting is on Jan 22 at 7pm! Location coming soon. Join us to meet the team and learn about what we do. Sign up for our interest form and follow us on Instagram at @pennspark so you won't miss a thing.
      </p>
