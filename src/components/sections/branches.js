      ...
      <div id="branches-section" className="content-section">
        ...
        >
          ...
          <p>
            ...
            <br />
            Anyone, but targeted towards beginners without previous coding
            and/or design experience.
          </p>
        </div>
        ...
        >
          ...
          <p>
            <span className="bold">What we do?</span>
            <br />
            Work in teams to build more advanced projects, either through
            working with real-world clients and nonprofits or on creatively
            brainstormed ideas.
            <br />
            <br />
            <span className="bold">Who can join?</span>
            <br />
            Returning members or new members with proficient technical
            experience.{" "}
            <em>
