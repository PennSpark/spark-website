...
export default function Navbar() {
  return (
        <nav className="w-[100svw] h-[52px] md:h-[70px] flex justify-center items-center gap-3 md:gap-6 font-light underline-offset-2 decoration-1 bg-black text-white text-xs md:text-base">
