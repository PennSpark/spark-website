...
import RespondCrisisDemoDb from "../../../../public/project-images/fa22/respond-demo.webp";
...
const demoVisuals = [
  <div key="v1">
    <p>
      {
        "Due to client privacy, we have refrained from publicly disclosing the database items. Below is the overview of all the data that we worked with:"
      }
    </p>
...
const sections: ProjectSection[] = [
  {
    ...
    content: [
      ...
      <br key="b1" />,
      <br key="b2" />,
      <strong key="b3">The major features include</strong>,
      <br key="b4" />,
    ...
    content: [
      <>
        ...
        <p style={{ fontStyle: "italic" }}>
          {" "}
          We are SO GRATEFUL to Paul and the Spark team for all they have done to
          help us automate our project management and payment system!! We do
          urgent, emergency response language access work, which grows and
          changes with each new global crisis that erupts. We were trying for
          over a year to find a project management platform that would both
          accommodate and streamline our workflow... and we just couldn't! In 3
          short months, the Spark team helped us build and connect exactly this
          system - we're now able to focus on actually doing our work -
          translating and interpreting for asylum seekers and migrants - instead
          of re-entering redundant data and worrying that stuff is falling
          through the cracks!
        </p>
        <br />
        ...
        <p style={{ fontStyle: "italic" }}>
          {" "}
          Spark team work has empowered our team to work a lot faster and
          effectively! Paul always paid attention to our needs and responded
          kindly with his knowledge and expertise. Overall, working with them
          was a pleasure and we couldn't be more thankful!
        </p>
        <br />
      </>,
    ],
...
export default function RespondCrisisTranslationPage() {
  return (
    <ProjectLayout
      project={project}
      demoUrl=""
